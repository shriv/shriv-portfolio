...
## RAPping with legacy code and Python
...
Python and its rich ecosystem of packages can even be used for complex pipelines that need to interface between different programs. Here, Python libraries like `exhangelib` and `saspy` can connect to APIs and programs like Outlook and SAS respectively. 
...
### Separating SAS code into mutable and immutable chunks 
...
## Jupyter notebooks for simple linear workflows
